...
const Landing = () => {
  return (
    <div className="min-h-screen bg-gradient-to-r from-blue-100 via-slate-100 to-orange-100 text-gray-800">
      {/* Navigation */}
      <nav className="bg-gradient-to-r from-blue-100 via-slate-100 to-orange-100 border-b border-gray-200">
      ...
      <div className="bg-gradient-to-r from-blue-100 via-slate-100 to-orange-100 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Join thousands of investors who trust Money tree for their investment journey.
          </p>
          <Link
            to="/register"
