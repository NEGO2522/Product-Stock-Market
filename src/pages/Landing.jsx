...
import { BarChart2, TrendingUp, Shield, Zap } from 'lucide-react';
    ...
    <div className="min-h-screen bg-white text-gray-800">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-xl font-bold text-gray-900">StockMarketPro</span>
            </div>
      ...
      <div className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="text-3xl font-bold text-gray-900 mb-6">Ready to take control of your investments?</h2>
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Join thousands of investors who trust StockMarketPro for their investment journey.
          </p>
          <Link
            to="/register"
            className="bg-gray-900 text-white px-8 py-3 rounded-md text-lg font-medium hover:bg-gray-700 transition-all transform hover:scale-105"
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <span className="ml-2 text-2xl font-bold text-gray-900">StockMarketPro</span>
              </div>
          ...
          <div className="mt-16 pt-8 border-t border-gray-200">
            <div className="md:flex md:items-center md:justify-between">
              <p className="text-gray-500 text-sm">
                &copy; {new Date().getFullYear()} StockMarketPro. All rights reserved.
              </p>
            ...
            <div className="mt-4">
              <p className="text-xs text-gray-400">
                StockMarketPro is a demo application. Not financial advice. Investing involves risk, including possible loss of principal.
              </p>
            </div>
          </div>
        </div>
